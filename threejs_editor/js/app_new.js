...
class App {
 ...
 if (!response.ok) {
 console.log('ℹ️ JSON demo non trovato (normale se non ancora scaricati i media)');
 return;
 }
 ...
 console.log('👁️ Click su "🎬 Play" per visualizzare!');
 ...
 break;
 case 'preview':
 // PREVIEW MODE CON TUTTI I PERCORSI
 console.log('Starting preview for:', nome);
 console.log('All routes:', Object.keys(this.uiManager.percorsiAttivi));
 
 if (Object.keys(this.uiManager.percorsiAttivi).length === 0) {
 ...
 // ✅ FIX: Formato content per ContentModal con proprietà 'type'
